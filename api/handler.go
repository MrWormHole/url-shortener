...
import (
	...
	jsonSerializer "github.com/mrwormhole/url-shortener/serializer/json"
	msgpackSerializer "github.com/mrwormhole/url-shortener/serializer/msgpack"
...
func (h *handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	redirect, err := h.redirectService.Find(hash)
	if err != nil {
